...
## 12. 실행 검증 결과 (자동 수집)
- 검증 일시: 자동 실행
- 실행 명령: `HOME=/home/Python_Ansible-Playbook ANSIBLE_LOCAL_TEMP=/home/Python_Ansible-Playbook/.ansible/tmp ANSIBLE_REMOTE_TEMP=/tmp/.ansible/tmp ANSIBLE_BECOME_ASK_PASS=False .venv/bin/ansible-playbook -i inventories/local/hosts.ini curriculum/lecture38/playbook.yml -e install_enabled=false`
...
- 실행 로그: `results/lecture-verification/logs/lecture38.log`

![lecture38 실행 캡처](../../results/lecture-verification/captures/lecture38.png)


## 13. 실행 검증 결과 (install_enabled=true 자동 수집)
- 검증 일시: 자동 실행
- 실행 명령: `HOME=/home/Python_Ansible-Playbook ANSIBLE_LOCAL_TEMP=/home/Python_Ansible-Playbook/.ansible/tmp ANSIBLE_REMOTE_TEMP=/tmp/.ansible/tmp ANSIBLE_BECOME_ASK_PASS=False .venv/bin/ansible-playbook -i inventories/local/hosts.ini curriculum/lecture38/playbook.yml -e install_enabled=true`
- 검증 상태: `PASS` (exit_code=0)
...
- 실행 로그: `results/lecture-verification-install/logs/lecture38.log`

![lecture38 install_enabled=true 실행 캡처](../../results/lecture-verification-install/captures/lecture38.png)
