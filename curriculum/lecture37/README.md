...
## 3. 학습 목표
- OpenStack 로그 수집과 장애 1차 진단 주제를 Ansible 중심으로 설명할 수 있다.
...
## 9. AI 페어링 가이드
- 사전 점검 프롬프트: OpenStack 로그 수집과 장애 1차 진단 실습 전에 실패할 수 있는 지점 3개를 체크리스트로 만들어줘.
...
## 12. 실행 검증 결과 (자동 수집)
- 검증 일시: 자동 실행
- 실행 명령: `HOME=/home/Python_Ansible-Playbook ANSIBLE_LOCAL_TEMP=/home/Python_Ansible-Playbook/.ansible/tmp ANSIBLE_REMOTE_TEMP=/tmp/.ansible/tmp ANSIBLE_BECOME_ASK_PASS=False .venv/bin/ansible-playbook -i inventories/local/hosts.ini curriculum/lecture37/playbook.yml -e install_enabled=false`
...
- 실행 로그: `results/lecture-verification/logs/lecture37.log`

![lecture37 실행 캡처](../../results/lecture-verification/captures/lecture37.png)


## 13. 실행 검증 결과 (install_enabled=true 자동 수집)
- 검증 일시: 자동 실행
- 실행 명령: `HOME=/home/Python_Ansible-Playbook ANSIBLE_LOCAL_TEMP=/home/Python_Ansible-Playbook/.ansible/tmp ANSIBLE_REMOTE_TEMP=/tmp/.ansible/tmp ANSIBLE_BECOME_ASK_PASS=False .venv/bin/ansible-playbook -i inventories/local/hosts.ini curriculum/lecture37/playbook.yml -e install_enabled=true`
- 검증 상태: `PASS` (exit_code=0)
...
- 실행 로그: `results/lecture-verification-install/logs/lecture37.log`

![lecture37 install_enabled=true 실행 캡처](../../results/lecture-verification-install/captures/lecture37.png)
